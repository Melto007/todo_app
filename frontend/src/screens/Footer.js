...
const Footer = () => {
  return (
    <div className="footer-container fixed bottom-0 w-[100%] bg-black text-white flex justify-between px-[0.2rem] py-[0.8rem] text-[0.7rem] sm:text-[0.9rem] sm:px-[0.4rem]">
        <p className="tracking-wide">created by @ <span className='text-pink'>melto.sm</span></p>
